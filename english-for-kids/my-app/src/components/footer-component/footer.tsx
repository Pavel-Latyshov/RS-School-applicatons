...
const Footer = ({ hideNav }: any) => {
  return (
    <div onClick={hideNav} className={css.footer_wrapper}>
      <div className={css.git_link}>
        <a href="https://github.com/Pavel-Latyshov">

...
const Train = ({ item }: any) => {
  ...
  return (
    <div className={imgClass}>
      <div
        onMouseLeave={flipFlag === false ? flipFlagChanger : undefined}
        className={flipFlag === true ? css.train_card : css.train_card_flip}
      >
        <img src={`${item[0]}`} alt="#" />
        <div className={css.train_panel}>
          ...
          <div className={flipClasses}>
            <img
              className={flipFlag === false ? css.hidden : undefined}
              src="https://www.svgrepo.com/show/119473/circular-arrow.svg"
            />
          </div>
        </div>
      </div>
